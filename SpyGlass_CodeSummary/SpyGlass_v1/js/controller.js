...
// Reporting
var ConsoleTradesCache = "";
var ConsoleQuotesCache = "";
...
function ControllerSetup() {
    ...
    if (DiagnosticMode) {
        console.warn("After Hours - Entering Diagnostic Mode");
        // a completely different program flow.
        DiagnosticControllerSetup();
        return;
    }
    ...
    if (!googleReady) {
        ...
        setTimeout(ControllerSetup, 100); // check again after 1 second
        return;
    }
...
ControllerStart = function () {
    ...
    //TEST ITEMS HERE
    //RecordCurrentGreeksAPI("SPY");

    // Subscribe to necessary websockets using range
    // REMOVE
    SubScribeToTicker(`SPY`); // quotes and trades will start coming in
